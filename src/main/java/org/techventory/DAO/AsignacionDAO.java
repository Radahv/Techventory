...
public class AsignacionDAO {
    ...
    public boolean asignarMaterial(Asignacion asignacion) {
        String query = "INSERT INTO asignaciones (id_usuario, id_material, cantidad_asignada) VALUES (?, ?, ?)";
        ...
        try (Connection conn = ConexionDB.getConexion();
            ...
            stmtAsignacion.setInt(2, asignacion.getId_material());
            ...
            stmtUpdateInventario.setInt(2, asignacion.getId_material());
